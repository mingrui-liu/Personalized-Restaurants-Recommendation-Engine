...
public class Item {
	...
	//add toJSONObject() method. Why?
	//To convert an Item object a JSONObject instance because 
	//in our application, frontend code cannot understand Java class, 
	...
	public static class ItemBuilder {
		//Add static class ItemBuilder in Item class. Copy all fields from Item to ItemBuilder.
		private String itemId;
		private String name;
		private double rating;
		private String address;
